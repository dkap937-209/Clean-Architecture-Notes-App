...
import com.dk.cleanarchitecturenotesapp.feature_note.domain.model.InvalidNoteException
...
class NotesViewModel @Inject constructor(
    ...
    private fun getNotes(noteOrder: NoteOrder) {
        getNotesJob?.cancel()
        getNotesJob = noteUseCases.getNotesUseCase(noteOrder = noteOrder).onEach{ notes->
            _state.value = state.value.copy(
                notes = notes,
                noteOrder = noteOrder
            )
